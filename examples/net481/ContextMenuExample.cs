...
public class ContextMenuExample : ExplorerCommandMenu {
    ...
    public override string Title => "Example Context Menu with .NET Framework 4.8.1";
    ...
    public static void Register(Type type) {
        RegistrationHelper.RegisterCommand(
            verbName: "ExampleContextMenu481",
    ...
    public static void Unregister(Type _) {
        RegistrationHelper.UnregisterCommand("ExampleContextMenu481");
    }
    #endregion
}
